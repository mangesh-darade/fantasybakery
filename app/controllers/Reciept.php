...
class Reciept extends MY_Controller {
    ...
    public function send_sms() {
        ...
        $str = '';
        if ($inv->grand_total):
            $str = 'Thanks for visiting ' . $this->Settings->site_name . '. Your Bill amount is ' . $this->sma->formatDecimal($inv->grand_total) . ' ' . $this->Settings->default_currency;
        endif;
...
//
       ...
       // $no = $this->input->get('phone');
        ...
        $pass_str = $str . ' & total award point balance till now is '. $customer_Award->award_points .' .'. $url;
...
//print_r($ResEshopOrder); exit;
    ...
    function verify_mobile() {
        ...
        $msg = 'Your OTP for redeeming award point is ' . $code . ' Fantasy Bakery n Patisserie.';
