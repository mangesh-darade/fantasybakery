...
class Site extends CI_Model {
    ...
    public function getPurchasedItem($where_clause) {
        ...
        $where_clause['option_id'] = $where_clause['option_id'] ? $where_clause['option_id'] : 0;
   ...
   /* public function syncVariantQty($variant_id, $warehouse_id, $product_id = NULL) {
    ...
    public function getPurchasedItems($product_id, $warehouse_id, $option_id = 0) {
        $orderby = ($this->Settings->accounting_method == 1) ? 'desc' : 'asc';
            ...
            foreach ($data as $items) {
                foreach ($items as $item) {
                    if (isset($item['pi_overselling'])) {
                        ...
                        $clause = array('product_id' => $item['product_id'], 'warehouse_id' => $item['warehouse_id'], 'option_id' => $option_id);
